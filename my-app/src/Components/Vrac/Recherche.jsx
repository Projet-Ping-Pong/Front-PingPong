    ...
    <div className="d-flex flex-column align-items-center w-100" style={{ width: "85%", paddingTop: "50px" }}>
      <div className="d-flex align-items-center my-1 justify-content-between mb-3" style={{ width: "85%", height: '5%' }}>
        ...
        <div className="mx-3 w-25 d-flex justify-content-end anim">
          ...
          {props.prov==="operation"?<button className="btn border border-2 px-4 button bg-primary" type="button" style={{ color: "#ffffff", }} onClick={() => {window.location.href = '/operationsCRUD'; sessionStorage.setItem("Provenance", "add")}}><FontAwesomeIcon icon="fa-solid fa-plus" />&nbsp;&nbsp; Ajout</button>:""}
          {props.prov==="gamme"?<button className="btn border border-2 px-4 button bg-primary" type="button" style={{ color: "#ffffff", }} onClick={() => {window.location.href = '/gammesCRUD'; sessionStorage.setItem("Provenance", "add")}}><FontAwesomeIcon icon="fa-solid fa-plus" />&nbsp;&nbsp; Ajout</button>:""}
        </div>
      </div>
    </div>
  </>
